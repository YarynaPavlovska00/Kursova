    ...
    return (
        <div>
            <div className={style.main}>
                <Card style={{width: '16rem', height: "420px"}}>
                    ...
                    <Card.Body>
                        ...
                        <div
                            ...
                            onClick={() => props.deleteItemFord(+props.data.id)}
                        >
                            <FontAwesomeIcon
                                icon={faTrash}
                            />
                ...
                {/*Edit*/}
                <EditAutoModal open={isEditModal} onClose={onClose} editItem={props.editItemFord} data={props.data}/>
